...
public class ProjectsController(ProjectService projectService) : ControllerBase
{
    ...
    public async Task<IActionResult> Create(AddProjectFormData projectFormData)
    {
        ...
        Console.WriteLine($"Received ProjectName: {projectFormData.ProjectName}");
        Console.WriteLine($"Received StatusId: {projectFormData.StatusId}");
        Console.WriteLine($"StatusId Type: {projectFormData.StatusId.GetType()}");
        Console.WriteLine($"========================");
